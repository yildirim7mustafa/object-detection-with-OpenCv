...
# orb tanımlayıcı
# köşe-kenar gibi nesneye ait özellikleri tespit edecek
orb = cv2.ORB_create()
...
#orb tanımlayıcı ile bu iş cok olmadı. çikolatalar yamuk oldugu icin sağlıklı çalışmadı
...
matches = bf.knnMatch(des1, des2, k = 2) #knn en yakın komsu
