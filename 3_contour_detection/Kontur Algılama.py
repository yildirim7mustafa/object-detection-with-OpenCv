#kontur algılama -> sekillerin kenarlarını algılama
import cv2 
...
#RETR_CCOMP = resmin iç ve dış konturleri bulmak, CHAIN_APPROX_SIMPLE = yatay dikey ve çapraz bölümleri sıkıştırıp, yalnızca uc noktaları bırakıyo
...
#teoride kodun çalışması gerekiyor ama hocam sürümsel farklılıktan çalışmayabilir dedi ve çalışmadı ...
